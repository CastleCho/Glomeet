...
const ReadNameScreen = ({navigation}) => {
    ...
    return(
        <SafeAreaView style={{backgroundColor: 'white', height: 900}}>
            <View style={{alignItems: 'center'}}>
                ...
                <View style={{marginTop: 30, alignItems: 'center', marginBottom: 40, height: 150}}>
                    ...
                    <TextInput
                        ...
                        style={{width: 132, height: 50, borderBottomWidth: 1, padding: 10}}
                    />
                    {showCheck && (
            ...
            <TouchableOpacity
                style={[styles.button, {shadowColor: '#000', shadowOffset: {width: 0, height: 3}, shadowOpacity: 0.5, shadowRadius: 2, elevation: 5}]}
                onPress={() => {
                    if (!selectedButton) {
